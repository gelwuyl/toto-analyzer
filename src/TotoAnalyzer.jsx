      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="flex sm:hidden items-center gap-2 pb-0">
          ...
          >
            ...
            <option value="planner">🎯 Next Bet &amp; ROI</option>
        ...
        <div className="hidden sm:flex border-b border-slate-800 gap-2 overflow-x-auto pb-1">
          ...
          <button onClick={() => setActiveTab('planner')} className={`px-5 py-3 font-semibold text-base rounded-t-xl transition-all border-b-2 flex items-center gap-2 whitespace-nowrap ${activeTab === 'planner' ? 'border-blue-500 text-blue-400 bg-slate-900/80' : 'border-transparent text-slate-400 hover:text-slate-200 hover:bg-slate-900/40'}`}>
            🎯 Next Bet & ROI
          </button>
          <button onClick={() => setActiveTab('data')} className={`px-5 py-3 font-semibold text-base rounded-t-xl transition-all border-b-2 flex items-center gap-2 whitespace-nowrap ${activeTab === 'data' ? 'border-amber-500 text-amber-400 bg-slate-900/80' : 'border-transparent text-slate-400 hover:text-slate-200 hover:bg-slate-900/40'}`}>
            📂 Data & Sync
          </button>
        </div>
        ...
        {activeTab === 'overview' && (
          ...
          <div className="space-y-2 animate-in fade-in duration-300">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 !mt-0">
              ...
              <div onClick={() => handleSelectMatchFilter(3)} className="bg-slate-900/90 border border-amber-500/30 rounded-xl p-3 shadow-lg hover:border-amber-500/60 cursor-pointer transition group">
              ...
              <div onClick={() => handleSelectMatchFilter(2)} className="bg-slate-900/90 border border-slate-800 rounded-xl p-3 shadow-lg hover:border-slate-700 cursor-pointer transition">
            ...
            <div className="space-y-4">
              ...
              {filteredPairs.length === 0 ? (
                ...
                filteredPairs.map((pair) => (
                  ...
                  <div key={pair.pairId} className={`bg-slate-900 border rounded-xl p-3 shadow-lg transition-all ${pair.matchCount >= 3 ? 'border-amber-500/40 bg-amber-950/10' : pair.matchCount === 2 ? 'border-slate-800 hover:border-slate-700' : 'border-slate-800/80 opacity-90'}`}>
...
<div className="bg-slate-900 border border-slate-800 rounded-xl p-4 sm:p-6 shadow-xl space-y-6">
              ...
              <div className="flex flex-col sm:flex-row justify-between sm:items-center gap-2 border-b border-slate-800 pb-4">
                ...
                <div>
                  ...
                  <h2 className="text-2xl font-bold text-white">Observed vs Expected Matches</h2>
